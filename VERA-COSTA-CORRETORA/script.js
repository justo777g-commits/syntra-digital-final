...
const EMPREENDIMENTOS = [
  {
    ...
    galeria: ['assets/empreendimentos/morada-dos-passaros-painel-resumo.webp','assets/empreendimentos/morada-dos-passaros-painel-plantas.webp','assets/empreendimentos/morada-dos-passaros-painel-lazer.webp','assets/empreendimentos/morada-dos-passaros-painel-ficha.webp']
  },
  {
    id: 'solare-residence',
    ...
    galeria: ['assets/empreendimentos/solare-residence-painel-resumo.webp','assets/empreendimentos/solare-residence-painel-plantas.webp','assets/empreendimentos/solare-residence-painel-lazer.webp','assets/empreendimentos/solare-residence-painel-ficha.webp']
  },
  {
    id: 'viver-aruana',
    nome: 'Viver Aruana',
    ...
    galeria: ['assets/empreendimentos/viver-aruana-painel-resumo.webp','assets/empreendimentos/viver-aruana-painel-plantas.webp','assets/empreendimentos/viver-aruana-painel-lazer.webp','assets/empreendimentos/viver-aruana-painel-ficha.webp']
  },
  {
    id: 'eloisio-sobral',
    ...
    galeria: ['assets/empreendimentos/eloisio-sobral-painel-resumo.webp','assets/empreendimentos/eloisio-sobral-painel-plantas.webp','assets/empreendimentos/eloisio-sobral-painel-lazer.webp','assets/empreendimentos/eloisio-sobral-painel-ficha.webp']
  },
  {
    id: 'summer-barra',
    nome: 'Summer Barra',
    ...
    galeria: ['assets/empreendimentos/summer-barra-painel-resumo.webp','assets/empreendimentos/summer-barra-painel-plantas.webp','assets/empreendimentos/summer-barra-painel-lazer.webp','assets/empreendimentos/summer-barra-painel-ficha.webp']
  },
  {
    id: 'lumiere-art-home',
    ...
    galeria: ['assets/empreendimentos/lumiere-art-home-painel-resumo.webp','assets/empreendimentos/lumiere-art-home-painel-plantas.webp','assets/empreendimentos/lumiere-art-home-painel-lazer.webp','assets/empreendimentos/lumiere-art-home-painel-ficha.webp']
  },
  {
    id: 'dune-simple-life',
    ...
    galeria: ['assets/empreendimentos/dune-simple-life-painel-resumo.webp','assets/empreendimentos/dune-simple-life-painel-plantas.webp','assets/empreendimentos/dune-simple-life-painel-lazer.webp','assets/empreendimentos/dune-simple-life-painel-ficha.webp']
  },
  {
    ...
    galeria: ['assets/empreendimentos/reserva-das-cores-painel-resumo.webp','assets/empreendimentos/reserva-das-cores-painel-plantas.webp','assets/empreendimentos/reserva-das-cores-painel-lazer.webp','assets/empreendimentos/reserva-das-cores-painel-ficha.webp']
  }
];
...
function renderPropertyDialog(item) {
  const gallery = item.galeria.map((src, index) => `
    <button class="property-gallery-item" type="button" data-lightbox="${escapeAttribute(src)}" aria-label="Ampliar imagem ${index + 1} de ${escapeAttribute(item.nome)}">
      <img src="${escapeAttribute(src)}" alt="Painel digital do empreendimento ${escapeAttribute(item.nome)} — imagem ${index + 1}" loading="lazy" />
    </button>`).join('');
  ...
  propertyDialogContent.innerHTML = `
    ...
    <aside class="property-book-disclaimer">Os painéis digitais organizam as informações do material comercial recebido e não substituem plantas, perspectivas ou documentos oficiais. Disponibilidade, unidades, valores, subsídios, metragens e condições devem ser confirmados com Vera Costa.</aside>
